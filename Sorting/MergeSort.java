...
public class MergeSort
{
    ...
    public void mergeSort(int array[], int left, int right)
    {
        ...
        /*Here i have used the following condition because if left= right then it means that the array is having only one element and we cannot divide an 
        array having only one element into two parts having positive length.
        The merge() function is also in this condition because if there is only one element then there is no need to merge it.... it's already merged. 
    ...
    public static void main(String[] args)
    {
        ...
        int n = sc.nextInt();            //Taking the input of the number of elements in the array.
        int array[] = new int[n];        //Initialised an array having n number of elements.
        ...
        m.mergeSort(array,0,n-1);        //Called the merge_sort function to sort the array using merge sort algorithm.
